...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color: #044b52;">
        <div class="container" >
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">SMPN1 MAROS</a>
            </div>
    ...
    <section id="about">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <p>Secara umum, Sistem Informasi Absensi ini mengandung tiga layanan atau fungsi utama yaitu proses pengaturan jadwal pelajaran, proses absensi dan proses rekap absensi. Selain itu.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="success" id="portfolio"  style="background-color:#6495ED;">
        <div class="container" >
            <div class="row">
                <div class="col-lg-12 text-center">
        ...
        <div class="footer-below">
            <div class="container">
                ...
                <ul class="list-inline">
                            <li>
                                <a href="#" class="btn-social btn-outline"><i class="fa fa-fw fa-university"></i></a>
                            </li>
                            <li>
                    ...
                    <div class="col-lg-12">
                    (&copy; Project1_Umar&Salmia 05/09/2021)
                    </div>
                </div>
            </div>
        </div>
