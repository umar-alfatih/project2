...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color: #044b52;">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="background-color:#044b52;"><b style="color: white">ABSENSI</b></a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="background-color: #044b52;">
                ...
                <div align="center">
                     ...
                     <h4 style="border-bottom: solid 1px grey; padding-bottom: 3px"><b style="color: aliceblue;">Tatausaha</b></h4>
                 </div>
                </li>

                    <li>
                        <a href="/siswaonline/tatausaha/index.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
