            ...
            <div class="tab-pane" id="<?php echo $row2['kelas']; ?>" style="margin-top:15px;">
                <div class="row">
                    <h4 class="page-header" style="margin-top:7px;" align="center">
                       <b> REKAP ABSENSI KELAS <?php echo $kela; ?></b>
                    </h4>

                    <div class="col-lg-13" style="padding-right:20px; border-right: 1px solid #ccc;">
                        ...
                        &nbsp &nbsp&nbsp
                        <input type="button" class="btn btn-primary" value="Print" onClick="return window.open('print.php?kelas=<?php echo $kelas; ?>&tgl1=<?php echo $tanggal1; ?>&tgl2=<?php echo $tanggal2; ?>','page','toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=750,height=600,left=50,top=50,titlebar=yes');"/>
